    	...
    	data: {
    		...
    		text:
				<span>Prop 2 allows the state to use money from the "Millionaire's tax" – a 1% income tax for those earning $1 million or more a year – to pay for housing for homeless people who are mentally ill.
					...
					<br/><br/>
					So it's thrown back to us, the voters. If passed, Prop 2 allows <em>No Place Like Home</em> to use $120M a year from the $2B a year generated by the Millionaire's tax.
				</span>,
    	},
    },
		{
